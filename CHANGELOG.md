...
Mark the project as archived. TypeScript 7 ships the native compiler as tsc, so a full-project check is fast enough for git hooks; the README explains the lint-staged replacement.
...
- [#55](https://github.com/jbabin91/tsc-files/pull/55) [`66e9618`](https://github.com/jbabin91/tsc-files/commit/66e9618dd5fbc59326b082c9e699d67dabe953c1) Thanks [@jbabin91](https://github.com/jbabin91)! - fix(config): resolve paths relative to baseUrl per TypeScript semantics
...
- [#40](https://github.com/jbabin91/tsc-files/pull/40) [`61ac197`](https://github.com/jbabin91/tsc-files/commit/61ac19713f02717598cc65958a3e9fac6904e46a) Thanks [@jbabin91](https://github.com/jbabin91)! - refactor(config): simplify config parsing with get-tsconfig
